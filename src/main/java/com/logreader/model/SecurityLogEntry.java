...
/**
 * An immutable representation of a single security log event within the system.
 * 
...
public record SecurityLogEntry(
    ...
    public String getFormattedEntry() {
        return String.format("(%s) -SECURITY- [%s] %s: %s (IP Address: %s)", id, timestamp, level, message, ipAddress);
    }
